/*
Module to enable the support playing audio on the BeagleBone Board
Usage: AudioMixter_init()
then writing waveFile -> AudioMixter_readWaveFileIntoMemory(...)
then queuing sounds to play -> AudioMixer_queueSound(...)
able to change volume as well
*/
